...
class Property(
    ...
    companion object {
        ...
        fun fromSale(items: Iterable<JsonNode>, state: String, city: String, houseType: HouseType): MutableList<Property> {
        ...
        fun fromRent(items: Iterable<JsonNode>, state: String, city: String, houseType: HouseType): MutableList<Property> {
            return items.map { item ->
                val property = propertyInit(item, state, city)
